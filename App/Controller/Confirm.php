...
class Confirm extends Contract\Controller {
	...
	protected function set_action() {
		return [
			Helper::control( 'button', [ 'value' => '戻る', 'data-action' => 'back' ] )->input(),
			Helper::control( 'button', [ 'value' => '送信', 'data-action' => 'complete' ] )->input(),
			Helper::control( 'hidden', [ 'name' => '_method', 'value' => 'complete' ] )->input(),
		];
	}
